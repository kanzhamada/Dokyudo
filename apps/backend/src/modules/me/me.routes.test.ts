...
describe("Me Routes Tests", () => {
  ...
  describe("DELETE /api/me/account", () => {
    it("negative: missing authorization header returns 401", async () => {
      const req = new Request("http://localhost/api/me/account", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  describe("PUT /api/me/update-password", () => {
    it("negative: missing authorization returns 401", async () => {
      const req = new Request("http://localhost/api/me/update-password", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
    ...
    it("negative: invalid token returns 401", async () => {
      const req = new Request("http://localhost/api/me/update-password", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  describe("PATCH /api/me/tenant/name", () => {
    it("negative: missing authorization returns 401", async () => {
      const req = new Request("http://localhost/api/me/tenant/name", {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },

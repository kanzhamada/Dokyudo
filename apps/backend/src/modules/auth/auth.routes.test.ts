...
Deno.test(
    "POST /api/auth/register — positive: successfully creates a user",
    async () => {
...
Deno.test(
    "POST /api/auth/register — negative: User-Agent anomaly detection drops IP limit to 3",
    async () => {
...
Deno.test(
    "POST /api/auth/register — negative: missing email returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            password: testPassword,
            recaptchaToken: "dummy-token",
...
Deno.test(
    "POST /api/auth/register — negative: invalid email format returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            email: "not-an-email",
            password: testPassword,
...
Deno.test(
    "POST /api/auth/register — negative: short password returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            email: testEmail,
            password: "short",
...
Deno.test(
    "POST /api/auth/register — negative: password too long returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            email: testEmail,
...
Deno.test(
    "POST /api/auth/register — negative: password missing uppercase returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            email: testEmail,
...
Deno.test(
    "POST /api/auth/register — negative: password missing lowercase returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            email: testEmail,
            password: "SECUREPASSWORD123!",
...
Deno.test(
    "POST /api/auth/register — negative: password missing number returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            email: testEmail,
...
Deno.test(
    "POST /api/auth/register — negative: password missing symbol returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            email: testEmail,
            password: "SecurePassword123",
...
Deno.test(
    "POST /api/auth/register — negative: missing recaptchaToken returns 400",
    async () => {
        const res = await makeRequest("/api/auth/register", {
            email: testEmail,
            password: testPassword,
...
Deno.test(
    "POST /api/auth/register — negative: empty body returns 400",
    async () => {
...
Deno.test(
    "POST /api/auth/login — positive: successfully logs in user",
    async () => {
...
Deno.test(
    "POST /api/auth/login — negative: wrong password returns 401",
    async () => {
        const res = await makeRequest("/api/auth/login", {
            email: testEmail,
...
Deno.test(
    "POST /api/auth/login — negative: missing email returns 400",
    async () => {
        const res = await makeRequest("/api/auth/login", {
            password: testPassword,
            recaptchaToken: "dummy-token",
...
Deno.test(
    "POST /api/auth/login — negative: missing password returns 400",
    async () => {
        const res = await makeRequest("/api/auth/login", {
            email: testEmail,
            recaptchaToken: "dummy-token",
...
Deno.test(
    "POST /api/auth/login — negative: invalid email format returns 400",
    async () => {
        const res = await makeRequest("/api/auth/login", {
            email: "bad-email",
            password: testPassword,
...
Deno.test(
    "POST /api/auth/login — negative: User-Agent anomaly detection drops IP limit to 3",
    async () => {
...
Deno.test(
    "POST /api/auth/login — negative: Per-Email Password Spraying Lockout at 5 attempts",
    async () => {
...
Deno.test(
    "POST /api/auth/logout — positive: successfully logs out user",
    async () => {
...
Deno.test(
    "POST /api/auth/logout — negative: missing authorization header returns 401",
    async () => {
        const req = new Request("http://localhost/api/auth/logout", {
            method: "POST",
        });
...
Deno.test(
    "POST /api/auth/logout — negative: invalid authorization header format returns 401",
    async () => {
        const req = new Request("http://localhost/api/auth/logout", {
            method: "POST",
            headers: {
...
Deno.test(
    "POST /api/auth/forget-password — positive: sends recovery email",
    async () => {
...
Deno.test(
    "POST /api/auth/forget-password — negative: missing email returns 400",
    async () => {
        const res = await makeRequest("/api/auth/forget-password", {
            recaptchaToken: "dummy-token",
        });
...
Deno.test(
    "POST /api/auth/reset-password — negative: invalid OTP returns 401",
    async () => {
...
Deno.test(
    "PUT /api/auth/update-password — negative: missing authorization header returns 401",
    async () => {
...
Deno.test(
    "POST /api/auth/forget-password — negative: rate limit exceeded at 5 attempts",
    async () => {
        const targetEmail = `forget-${crypto.randomUUID()}@example.com`;
        const spamIp = `192.168.50.${Math.floor(Math.random() * 255)}`;

        // Send 5 requests to trip the limit
        for (let i = 1; i <= 5; i++) {
            await makeRequest(
...
Deno.test(
    "POST /api/auth/reset-password — negative: missing otp returns 400",
    async () => {
        const res = await makeRequest("/api/auth/reset-password", {
            email: testEmail,
            newPassword: "NewSecurePassword123!",
...
Deno.test(
    "POST /api/auth/reset-password — negative: short password returns 400",
    async () => {
        const res = await makeRequest("/api/auth/reset-password", {
            email: testEmail,
            otp: "123456",
...
Deno.test(
    "PUT /api/auth/update-password — negative: short password returns 400",
    async () => {
        const req = new Request("http://localhost/api/auth/update-password", {
            method: "PUT",
            headers: {
...
Deno.test(
    "Error responses include requestId from X-Request-ID header",
    async () => {
...
Deno.test(
    "Error responses always have the standard envelope shape",
    async () => {
        const res = await makeRequest("/api/auth/login", {});

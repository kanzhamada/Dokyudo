...
// Removed: PUT /api/auth/update-password — moved to PUT /api/me/update-password
// Removed: PATCH /api/auth/tenant/name — moved to PATCH /api/me/tenant/name
// Removed: DELETE /api/auth/account — moved to DELETE /api/me/account
// (see src/modules/me/me.routes.ts).

...
## Tasks
- [ ] Refaktor `extractor.py` untuk mengimplementasikan Recursive Character Text Splitting
- [ ] Buat logika pemecahan hirarkis (Parent-Child)
- [ ] Ubah pipeline *embedding* agar hanya memproses *Child Chunks*
- [ ] Update struktur metadata vektor di Upstash agar *Child* memegang referensi ke *Parent* ID-nya
- [ ] Sesuaikan logika pencarian di API Gateway untuk menarik `Parent Chunk` penuh berdasarkan hasil referensi pencarian dari `Child Chunk`
